...
export declare type IAlertDialogComponentType = ((props: IAlertDialogProps & {
...
export declare type IAlertDialogProps = InterfaceAlertDialogProps | CustomProps<'AlertDialog'>;

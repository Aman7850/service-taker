...
export declare type FormControlComponentType = ((props: IFormControlProps) => JSX.Element) & {
...
export declare type IFormControlProps = InterfaceFormControlProps | CustomProps<'FormControl'>;

...
export interface InterfaceSwitchProps extends Omit<SwitchProps, 'tintColor'>, StyledProps {
    /**
...
export declare type ISwitchProps = InterfaceSwitchProps | CustomProps<'Switch'>;

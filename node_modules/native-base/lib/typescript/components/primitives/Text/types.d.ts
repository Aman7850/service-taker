...
export interface InterfaceTextProps extends PlatformProps<ITextProps>, StyledProps, TextProps {
    /**
...
export declare type ITextProps = InterfaceTextProps | CustomProps<'Text'>;
